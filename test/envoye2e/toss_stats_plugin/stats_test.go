...
var Runtimes = []struct {
...
}{
	{
		...
		StatsFilterCode:            "inline_string: \"envoy.wasm.toss_stats\"",
	...
	},
	{
		...
		StatsFilterCode:            "filename: " + filepath.Join(env.GetBazelBinOrDie(), "extensions/toss_stats.wasm"),
	...
	},
	{
		...
		StatsFilterCode:            "filename: " + filepath.Join(env.GetBazelBinOrDie(), "extensions/toss_stats.compiled.wasm"),
		WasmRuntime:                "envoy.wasm.runtime.v8",
	},
}
...
func TestStatsParserRegression(t *testing.T) {
	t.Logf("TestStatsParserRegression")
